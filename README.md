...
BAF 26-1 팀 프로젝트를 개인 포트폴리오 제출용으로 정리한 저장소입니다. 원본 팀 프로젝트 전체를 복사하지 않고, 최종 발표자료 기준으로 USDC와 DAI 스테이블코인의 디페깅 조기경보 모델 흐름을 재구성했습니다.
...
- 이 포트폴리오 저장소는 원본 데이터 전체를 포함하지 않아 전체 재실행이 제한됩니다.

## My Contribution

개인 기여는 텍스트 변수 실험과 결과 정리에 집중되어 있습니다.
