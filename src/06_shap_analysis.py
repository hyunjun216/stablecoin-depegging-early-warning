"""
Purpose:
    Explain the final tree-based models with SHAP global and local
    attribution analysis.

Input:
    data/ml/best_config.json and USDC/DAI X/Y modeling files.

Output:
    SHAP value tables and SHAP summary/bar/dependence plots.

Notes:
    SHAP is used for interpretation after cross-validation experiments. The
    full-data fit in this script is for explanation, not for reporting
