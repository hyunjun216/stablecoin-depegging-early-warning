"""
Purpose:
    Compare class imbalance handling strategies for rare depegging events.

Input:
    data/ml/X_{coin}.csv and data/ml/Y_{coin}.csv.

Output:
    data/ml/imbalance_results.csv with cross-validated F2, Recall, Precision,
    AUC-PR, and AUC-ROC metrics.

Notes:
    Final presentation choice: USDC uses WeightOnly and DAI uses ADASYN.
    StratifiedKFold is used because depegging events are sparse and clustered,
    especially in 2020. This is a methodological limitation, not a production
    validation scheme.
"""
