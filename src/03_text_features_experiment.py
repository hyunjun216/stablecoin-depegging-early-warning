"""
Purpose:
    Generate news-based text features for the text feature experiment.

Input:
    data/raw/news_raw.csv with daily stablecoin-related news text.

Output:
    data/processed/text_features.csv containing keyword, risk dictionary, and
    LDA topic features.

Notes:
    Text features from keyword dictionaries, LDA topics, and FinBERT-derived
    features were evaluated, but they did not improve the final F2-score and
    were excluded from the final XGBoost model.
"""
