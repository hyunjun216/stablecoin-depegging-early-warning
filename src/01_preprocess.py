"""
Purpose:
    Prepare daily USDC and DAI modeling tables from raw market, macro,
    on-chain, search, and DeFi inputs.

Input:
    data/raw/*.csv files supplied separately from the portfolio repository.

Output:
    data/processed/df_usdc.csv, data/processed/df_dai.csv, and supporting
    processed tables.

Notes:
    Portfolio version of the BAF 26-1 team project preprocessing script.
    The final presentation defines depegging with Typical Price,
    |TP - 1| > 0.01, and a 2-of-3 persistence filter. Reproduction requires
    the original raw data, which is not included in this repository.
"""
